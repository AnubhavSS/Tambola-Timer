...
export const useTimerStore = create<TimerState>((set) => ({
  ...
  progress: 0,
  play_pause: true,
  togglePlayPause: () => set((state) => ({ play_pause: !state.play_pause })),
  currentNumber: 0,
  previousNumber: null,
  history: [],
  ...
  setShowPreviousModal: () => set((state) => ({ showPreviousModal: !state.showPreviousModal })), // Function to set showPreviousModal state
   resetStore: () =>
    set({
      progress: 0,
      play_pause: true,
